...
public class XmlInfo {
    ...
    public static final String appimports = "app:imports";
    public static final String appclick = "app:click";
    public static final String applongclick = "app:longclick";
    public static final String apptouch = "app:touch";
    public static final String appaction = "app:action";
