...
```Java
	dependencies {
                ...
              implementation 'com.hacknife.briefness:briefness:2.2.0'
    	      annotationProcessor 'com.hacknife.briefness:briefness-compiler:2.2.0'
	}
```
## 混淆
```Java
