...
```Java
	dependencies {
                ...
              implementation 'com.hacknife.briefness:briefness:2.2.5'
    	      annotationProcessor 'com.hacknife.briefness:briefness-compiler:2.2.5'
	}
```
## 混淆
```Java
