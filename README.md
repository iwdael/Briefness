...
```Java
	dependencies {
                ...
              implementation 'com.hacknife.briefness:briefness:2.2.7'
    	      annotationProcessor 'com.hacknife.briefness:briefness-compiler:2.2.7'
	}
```
## 混淆
```Java
