...
```Java
	dependencies {
                ...
              implementation 'com.hacknife.briefness:briefness:2.2.8'
    	      annotationProcessor 'com.hacknife.briefness:briefness-compiler:2.2.8'
	}
```
## 混淆
```Java
